...
public class TestConfig implements CommandLineRunner{
	...
	// executar quando o programa for iniciado // implements CommandLineRunner // metodo da interface
	@Override
	public void run(String... args) throws Exception {
		...
		// ========================================================================
		// Associando os produtos com as categorias conforme mapeado no material de apoio
